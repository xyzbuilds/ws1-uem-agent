...
//
// If the keychain is unavailable AND WS1_ALLOW_DISK_SECRETS is set, the
// secret falls back to ~/.config/ws1/secrets.<profile>.json with mode 0600.
// This is the open-question-#1 default per spec section 13.
...
// GetClientSecret reads the client_secret for a profile.
